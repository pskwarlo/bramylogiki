...
@Getter
public class Level9 implements LevelController {
    @FXML
    ...
    public void initialize() {
        ...
        GateInit.initNot(700, 200, dragController, pnlCanvas);
        GateInit.initNot(700, 350, dragController, pnlCanvas);
        GateInit.initNor(900, 275, dragController, pnlCanvas);



        GateInit.initPower(true, 425, 100, dragController, pnlCanvas);
        GateInit.initPower(true, 425, 200, dragController, pnlCanvas);
        GateInit.initPower(false, 425, 350, dragController, pnlCanvas);
